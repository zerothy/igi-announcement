        ...
        <div className='w-[18.5rem] md:w-[30.5rem] h-[18.5rem] md:h-[30.5rem] z-[80] bg-[#671111] border-4 border-solid border-primary flex flex-wrap'>
            {
                ...
                (order.map((tile, index) => (
                    <motion.img
                        ...
                        alt={`${tile}`}
                        className={`${totalWins === 0 ? 'w-[6rem] h-[6rem] md:w-[10rem] md:h-[10rem]' : (totalWins === 1 ? 'w-[3.6rem] h-[3.6rem] md:w-[6rem] md:h-[6rem]' : 'w-[2.571rem] h-[2.571rem] md:w-[4.285rem] md:h-[4.285rem]')} border border-solid border-gray-500 ${tile === 9 ? 'opacity-0' : ''}`}
                        key={tile}
